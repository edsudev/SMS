...
namespace EDSU_SYSTEM.Data.Migrations
{
    ...
    [Migration("20230116230841_Evaluation and Results")]
    partial class EvaluationandResults
    {
            ...
            modelBuilder.Entity("EDSU_SYSTEM.Models.Evaluation", b =>
                {
                    ...
                    b.HasOne("EDSU_SYSTEM.Models.EvaluationGrade", "Grades")
                        .WithMany()
                        .HasForeignKey("Grade")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
